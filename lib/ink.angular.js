...
window.matchMedia || ( window.matchMedia = function() {
	window.console && console.warn && console.warn('Ink: This browser does not support matchMedia, '+
...
ink.directive('inkProgress', ['prefix', function () {
	return {
		restrict: 'E',
		replace: true,
		transclude: true,
